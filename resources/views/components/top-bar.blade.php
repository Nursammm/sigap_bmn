  <div class="sticky top-0 z-30 flex h-16 items-center gap-2 bg-gray-800 px-4 text-white md:hidden">
    <button @click="sidebarOpen=true" class="rounded-md p-2 text-gray-300 hover:bg-white/10 hover:text-white focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500" aria-label="Buka menu">
